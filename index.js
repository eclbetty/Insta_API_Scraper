...
const numberOfDMPerHour = 5;
var cursor; 
var followersArray = db.newTarget || [];
var anchorI = db.dmedTarget.length + 5;

// Setup account here
const zuccermann = credentials.zuccermann;
const zuccermann2 = credentials.zuccermann2;
const zuccermann3 = credentials.zuccermann3;
const zuccermann24 = credentials.zuccermann24;
const zuccermann25 = credentials.zuccermann25;
const _18aboveclub = credentials['18aboveclub'];
